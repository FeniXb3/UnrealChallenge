 ...
 */
@AgentScoped
public class Panicator extends UT2004BotModuleController<UT2004Bot> {
    ...
    public Initialize getInitializeCommand() {
        ...
        return new Initialize().setTeam(0).setName("Panicator-" + (++instanceCount)).setDesiredSkill(5);
    }
    ...
    public void logic() {    	
        ...
        if(getWeaponry().getCurrentAmmo() > 1) {
...
//        // 1) do you see enemy? 	-> go to PURSUE (start shooting / hunt the enemy)
    ...
    protected void stateEngage() {
        ...
        if (enemy == null || !enemy.isVisible()) {
            ...
            if (enemy == null) {
               ...
               // body.getCommunication().sendGlobalTextMessage("I can see dead people. You are dead, " + enemy.getName() + ".");
    ...
    protected void stateHit() {
        ...
        getAct().act(new Jump().setDoubleJump(true));
    ...
    protected void stateHearVoices() {        
        body.getCommunication().sendGlobalTextMessage("What was that...?");
    ...
    public static void main(String args[]) throws PogamutException {
    	...
    	new UT2004BotRunner(Panicator.class, "Panicator").setMain(true)
                //.setHost("10.11.251.232")
                
                .setLogLevel(Level.INFO).startAgents(1);
    }
}
